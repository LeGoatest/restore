<section class="section">
    <div class="site-main">
        ...
        <?php foreach ($services as $category => $serviceGroup): ?>
        <div class="mb-12">
            <h2 class="text-2xl font-bold mb-6 text-center"><?= htmlspecialchars($serviceGroup['title']) ?></h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <?php foreach ($serviceGroup['items'] as $service): ?>
                <div class="service-card">
                    <h3 class="font-semibold mb-2"><?= htmlspecialchars($service) ?></h3>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
