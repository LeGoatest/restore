...
<aside class="admin-sidebar">
    ...
    <div class="admin-sidebar-header">
        <div class="flex items-center space-x-3">
            <div class="w-8 h-8 bg-blue-400 rounded-lg flex items-center justify-center">
                <i class="icon-[mdi--account] text-white text-lg"></i>
            </div>
            <div>
                <h2 class="text-lg font-semibold">Client Hub</h2>
    ...
    <nav class="admin-sidebar-nav">
        <ul class="space-y-2">
            <!-- Hub -->
            <li>
                <a href="/clienthub" class="flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-800 active">
